...
| `token_f1_gain_over_source_copy` | -0.2793 |
...
- Prediction: `writing, praised ' michael the american describes stated critical was smart ' s episode, who @ of but confident as and film power - context and acting.`
- Exact match: `0.000`
- Token F1: `0.241`
...
- Prediction: `a was player a the team team to an an batsman of one of season of army.`
- Exact match: `0.000`
- Token F1: `0.333`
...
- Prediction: `though, united was the political as over much world about and states @ to canada era ' new people american a canadian of catholic.`
- Exact match: `0.000`
- Token F1: `0.233`
...
- Prediction: `on 23 1, @ - @ - guns in 4 21. s guns were 8.`
- Exact match: `0.000`
- Token F1: `0.154`
...
- Prediction: `it was the a main 11 ( belt ( 6 4 95 ( @ ( 7 ( and @. @ 5 11 ) ( m 4 mph ( 12 ) by ) 14 ( @ ) apart ( 8 feet ( @ mm km )`
- Exact match: `0.000`
- Token F1: `0.247`
