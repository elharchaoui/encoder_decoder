...
- Config: `configs/prefix_memory_qwen05_distill_squad_30k_seed37.yaml`
- Checkpoint: `runs/prefix_memory_qwen05_distill_squad_30k_seed37/best`
...
| Metric | Value |
| --- | ---: |
| `validation_loss` | 4.3501 |
| `perplexity` | 77.48 |
| `generation_examples` | 256.0000 |
| `prefix_exact_match` | 0.0000 |
| `prefix_token_f1` | 0.0045 |
| `source_copy_token_f1` | 0.0418 |
| `prefix_prediction_source_copy_ratio` | 0.0602 |
| `decoder_baseline_exact_match` | 0.0156 |
| `decoder_baseline_token_f1` | 0.1380 |
| `decoder_baseline_prediction_source_copy_ratio` | 0.7297 |
| `prefix_unique_predictions` | 35.0000 |
| `prefix_top_prediction_ratio` | 0.3164 |
| `decoder_baseline_unique_predictions` | 256.0000 |
| `decoder_baseline_top_prediction_ratio` | 0.0039 |
| `prefix_gain_over_source_copy` | -0.0372 |
| `prefix_gap_to_decoder_baseline` | 0.1335 |
| `prefix_target_len_1_token_f1` | 0.0000 |
| `target_len_1_examples` | 78.0000 |
| `prefix_target_len_2_3_token_f1` | 0.0065 |
| `target_len_2_3_examples` | 112.0000 |
| `prefix_target_len_4_6_token_f1` | 0.0049 |
| `target_len_4_6_examples` | 45.0000 |
| `prefix_target_len_7_plus_token_f1` | 0.0095 |
...
- Target: `a majority`
- Prefix-memory prediction: `theHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHumanHuman`
- Decoder-only baseline: `The parliament must vote by a majority of all meps to block or suggest changes to the commission's proposals.`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.190`
...
- Target: `scandinavia`
- Prefix-memory prediction: `the 19th century`
- Decoder-only baseline: `The answer is scandinavian. The context mentions that "bairn" and "hyem" are examples of geordie words with origins in Scandin`
- Prefix-memory token F1: `0.000`
...
- Target: `guidance`
- Prefix-memory prediction: `the 19th century`
- Decoder-only baseline: `The Europeans thought the peoples in the tropics needed guidance and intervention from the European empire to aid in the governing of a more evolved social structure.`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.071`
...
- Prefix-memory prediction: `the 19th century`
- Decoder-only baseline: `The answer is that students learn about church and the methodist-christian theological tradition in order to profess their ultimate faith in christ. The other options are`
- Prefix-memory token F1: `0.222`
- Decoder baseline token F1: `0.375`
...
- Prefix-memory prediction: `1900`
- Decoder-only baseline: `The two major thoroughfares of Sunnyside are Kings Canyon Avenue and Clovis Avenue.`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.526`
...
- Prefix-memory prediction: `1990`
- Decoder-only baseline: `The Zachęta National Gallery of Art organizes exhibitions of art from...`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.000`
...
- Prefix-memory prediction: `1800`
- Decoder-only baseline: `Luther had a position as a doctor of theology.`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.167`
...
- Prefix-memory prediction: `1800`
- Decoder-only baseline: `Sweyn Forkbeard.`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.500`
