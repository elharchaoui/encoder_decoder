...
- Config: `configs/t5_small_xa_squad_ctx320_eval.yaml`
...
| `prediction_source_token_f1` | 0.0440 |
| `prediction_source_copy_ratio` | 0.8167 |
| `unique_predictions` | 507.0000 |
| `top_prediction_ratio` | 0.0039 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 3.1680 |
| `max_prediction_length_tokens` | 14.0000 |
| `target_len_1_token_f1` | 0.7096 |
| `target_len_1_examples` | 154.0000 |
| `target_len_2_3_token_f1` | 0.7544 |
| `target_len_2_3_examples` | 221.0000 |
| `target_len_4_6_token_f1` | 0.6468 |
| `target_len_4_6_examples` | 91.0000 |
| `target_len_7_plus_token_f1` | 0.6016 |
| `target_len_7_plus_examples` | 46.0000 |
| `token_f1_gain_over_source_copy` | 0.6654 |
