...
| `prediction_source_token_f1` | 0.0473 |
| `prediction_source_copy_ratio` | 0.3327 |
| `unique_predictions` | 389.0000 |
| `top_prediction_ratio` | 0.0547 |
| `empty_prediction_ratio` | 0.0020 |
| `avg_prediction_length_tokens` | 1.7402 |
| `max_prediction_length_tokens` | 6.0000 |
| `target_len_1_token_f1` | 0.3781 |
| `target_len_1_examples` | 180.0000 |
| `target_len_2_3_token_f1` | 0.2808 |
| `target_len_2_3_examples` | 332.0000 |
| `token_f1_gain_over_source_copy` | 0.2857 |
