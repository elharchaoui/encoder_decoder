...
| `prediction_source_token_f1` | 0.0552 |
| `prediction_source_copy_ratio` | 0.3703 |
| `unique_predictions` | 363.0000 |
| `top_prediction_ratio` | 0.0566 |
| `empty_prediction_ratio` | 0.0020 |
| `avg_prediction_length_tokens` | 1.7070 |
| `max_prediction_length_tokens` | 5.0000 |
| `target_len_1_token_f1` | 0.3815 |
| `target_len_1_examples` | 180.0000 |
| `target_len_2_3_token_f1` | 0.2651 |
| `target_len_2_3_examples` | 332.0000 |
| `token_f1_gain_over_source_copy` | 0.2767 |
