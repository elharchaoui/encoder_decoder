...
- Config: `configs/t5_small_frozen_encoder_wikitext_span_short_eval512.yaml`
...
| `prediction_source_token_f1` | 0.0599 |
| `prediction_source_copy_ratio` | 0.4324 |
| `unique_predictions` | 312.0000 |
| `top_prediction_ratio` | 0.0742 |
| `empty_prediction_ratio` | 0.0020 |
| `avg_prediction_length_tokens` | 1.5957 |
| `max_prediction_length_tokens` | 7.0000 |
| `target_len_1_token_f1` | 0.1861 |
| `target_len_1_examples` | 175.0000 |
| `target_len_2_3_token_f1` | 0.2037 |
| `target_len_2_3_examples` | 337.0000 |
| `token_f1_gain_over_source_copy` | 0.1683 |
