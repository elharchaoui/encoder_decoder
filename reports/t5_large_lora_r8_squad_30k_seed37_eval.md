...
- Checkpoint: `runs/t5_large_lora_r8_squad_30k_seed37/best`
- Data source: `qa`
...
| `prediction_source_token_f1` | 0.0409 |
| `prediction_source_copy_ratio` | 0.7934 |
| `unique_predictions` | 254.0000 |
| `top_prediction_ratio` | 0.0078 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 2.9883 |
| `max_prediction_length_tokens` | 13.0000 |
| `target_len_1_token_f1` | 0.8026 |
| `target_len_1_examples` | 78.0000 |
| `target_len_2_3_token_f1` | 0.8350 |
| `target_len_2_3_examples` | 112.0000 |
| `target_len_4_6_token_f1` | 0.8546 |
| `target_len_4_6_examples` | 45.0000 |
| `target_len_7_plus_token_f1` | 0.6725 |
| `target_len_7_plus_examples` | 21.0000 |
| `token_f1_gain_over_source_copy` | 0.7735 |
