...
- Config: `configs/t5_small_xa_squad_ctx512_eval.yaml`
- Checkpoint: `runs/t5_small_xa_squad_512tok_seed37/best`
- Data source: `qa`
...
| `prediction_source_token_f1` | 0.0453 |
| `prediction_source_copy_ratio` | 0.8155 |
| `unique_predictions` | 506.0000 |
| `top_prediction_ratio` | 0.0039 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 3.3027 |
| `max_prediction_length_tokens` | 14.0000 |
| `target_len_1_token_f1` | 0.7261 |
| `target_len_1_examples` | 154.0000 |
| `target_len_2_3_token_f1` | 0.7695 |
| `target_len_2_3_examples` | 221.0000 |
| `target_len_4_6_token_f1` | 0.6723 |
| `target_len_4_6_examples` | 91.0000 |
| `target_len_7_plus_token_f1` | 0.5839 |
| `target_len_7_plus_examples` | 46.0000 |
| `token_f1_gain_over_source_copy` | 0.6798 |
...
- Target: `a majority`
- Prediction: `vote by a majority of all meps`
- Exact match: `0.000`
- Token F1: `0.444`
...
- Target: `guidance`
- Prediction: `guidance and intervention from the european empire to aid in the governing of a`
- Exact match: `0.000`
- Token F1: `0.133`
- Prediction-source copy ratio: `1.000`
...
- Prediction: `the oldest exhibition site in warsaw`
- Exact match: `0.000`
- Token F1: `0.000`
- Prediction-source copy ratio: `1.000`
