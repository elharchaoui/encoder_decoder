...
- Config: `configs/gpt2_small_squad_ctx192_eval.yaml`
...
- Target: `a majority`
- Prediction: `qualified majority in the council`
- Exact match: `0.000`
- Token F1: `0.286`
