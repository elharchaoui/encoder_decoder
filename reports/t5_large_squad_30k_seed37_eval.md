...
- Checkpoint: `runs/t5_large_squad_30k_seed37/best`
- Data source: `qa`
...
| `prediction_source_token_f1` | 0.0405 |
| `prediction_source_copy_ratio` | 0.7935 |
| `unique_predictions` | 255.0000 |
| `top_prediction_ratio` | 0.0078 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 2.9258 |
| `max_prediction_length_tokens` | 14.0000 |
| `target_len_1_token_f1` | 0.8079 |
| `target_len_1_examples` | 78.0000 |
| `target_len_2_3_token_f1` | 0.8392 |
| `target_len_2_3_examples` | 112.0000 |
| `target_len_4_6_token_f1` | 0.8466 |
| `target_len_4_6_examples` | 45.0000 |
| `target_len_7_plus_token_f1` | 0.6588 |
| `target_len_7_plus_examples` | 21.0000 |
| `token_f1_gain_over_source_copy` | 0.7744 |
...
- Target: `guidance`
- Prediction: `guidance and intervention from the european empire`
- Exact match: `0.000`
- Token F1: `0.250`
- Prediction-source copy ratio: `1.000`
