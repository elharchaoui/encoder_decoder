...
- Config: `configs/prefix_memory_qwen05_adapter_squad_debug.yaml`
- Checkpoint: `runs/prefix_memory_qwen05_adapter_squad_debug/best`
...
| Metric | Value |
| --- | ---: |
| `validation_loss` | 4.7235 |
| `perplexity` | 112.56 |
| `generation_examples` | 64.0000 |
| `prefix_exact_match` | 0.0000 |
| `prefix_token_f1` | 0.0210 |
| `source_copy_token_f1` | 0.0368 |
| `prefix_prediction_source_copy_ratio` | 0.4535 |
| `decoder_baseline_exact_match` | 0.0156 |
| `decoder_baseline_token_f1` | 0.1390 |
| `decoder_baseline_prediction_source_copy_ratio` | 0.7500 |
| `prefix_unique_predictions` | 7.0000 |
| `prefix_top_prediction_ratio` | 0.8281 |
| `decoder_baseline_unique_predictions` | 64.0000 |
| `decoder_baseline_top_prediction_ratio` | 0.0156 |
| `prefix_gain_over_source_copy` | -0.0158 |
| `prefix_gap_to_decoder_baseline` | 0.1180 |
| `prefix_target_len_1_token_f1` | 0.0000 |
| `target_len_1_examples` | 18.0000 |
| `prefix_target_len_2_3_token_f1` | 0.0229 |
| `target_len_2_3_examples` | 32.0000 |
| `prefix_target_len_4_6_token_f1` | 0.0404 |
| `target_len_4_6_examples` | 11.0000 |
| `prefix_target_len_7_plus_token_f1` | 0.0556 |
| `target_len_7_plus_examples` | 3.0000 |
...
- Target: `a majority`
- Prefix-memory prediction: `the first century`
- Decoder-only baseline: `The parliament must vote by a majority of all meps to block or suggest changes`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.235`
...
- Target: `scandinavia`
- Prefix-memory prediction: `the first century`
- Decoder-only baseline: `The answer is scandinavian. The context mentions that "bairn"`
- Prefix-memory token F1: `0.000`
...
- Target: `guidance`
- Prefix-memory prediction: `the first century`
- Decoder-only baseline: `The Europeans thought the peoples in the tropics needed guidance and intervention from the European`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.125`
...
- Prefix-memory prediction: `the first century`
- Decoder-only baseline: `The answer is that students learn about church and the methodist-christian theological`
- Prefix-memory token F1: `0.222`
- Decoder baseline token F1: `0.556`
...
- Prefix-memory prediction: `the first`
- Decoder-only baseline: `The two major thoroughfares of Sunnyside are Kings Canyon Avenue and`
- Prefix-memory token F1: `0.000`
- Decoder baseline token F1: `0.471`
