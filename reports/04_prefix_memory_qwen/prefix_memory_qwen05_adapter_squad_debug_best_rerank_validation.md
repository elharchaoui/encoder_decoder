...
| `prefix_accuracy` | 0.1406 |
| `prefix_mean_reciprocal_rank` | 0.3378 |
| `prefix_gold_loss` | 5.0021 |
| `prefix_best_loss` | 2.6734 |
| `prefix_gold_best_loss_margin` | 2.3287 |
| `prefix_prediction_token_f1` | 0.1484 |
| `random_accuracy_baseline` | 0.1250 |
| `decoder_baseline_accuracy` | 0.6719 |
| `decoder_baseline_mean_reciprocal_rank` | 0.7660 |
| `decoder_baseline_gold_loss` | 4.5580 |
| `decoder_baseline_best_loss` | 3.5583 |
| `decoder_baseline_gold_best_loss_margin` | 0.9997 |
| `decoder_baseline_prediction_token_f1` | 0.6719 |
...
- Gold: `a majority`
- Prefix prediction: `autumn 1347`
- Prefix gold rank: `4`
- Decoder baseline prediction: `autumn 1347`
- Decoder baseline gold rank: `6`
...
- Gold: `scandinavia`
- Prefix prediction: `1884`
- Prefix gold rank: `3`
- Decoder baseline prediction: `1884`
- Decoder baseline gold rank: `3`
...
- Gold: `guidance`
- Prefix prediction: `during the 16th and 17th centuries`
- Prefix gold rank: `5`
- Decoder baseline prediction: `during the 16th and 17th centuries`
- Decoder baseline gold rank: `4`
...
- Gold: `church and the methodist-christian theological tradition`
- Prefix prediction: `warsaw`
- Prefix gold rank: `4`
- Decoder baseline prediction: `church and the methodist-christian theological tradition`
- Decoder baseline gold rank: `1`
...
- Gold: `kings canyon avenue and clovis avenue`
- Prefix prediction: `apollo 17`
- Prefix gold rank: `6`
- Decoder baseline prediction: `kings canyon avenue and clovis avenue`
- Decoder baseline gold rank: `1`
...
- Gold: `polish and international artists`
- Prefix prediction: `regeneration`
- Prefix gold rank: `5`
- Decoder baseline prediction: `polish and international artists`
- Decoder baseline gold rank: `1`
...
- Gold: `doctor in bible`
- Prefix prediction: `autumn 1347`
- Prefix gold rank: `7`
- Decoder baseline prediction: `autumn 1347`
- Decoder baseline gold rank: `2`
...
- Prefix prediction: `1206`
- Prefix gold rank: `6`
- Decoder baseline prediction: `sweyn forkbeard`
- Decoder baseline gold rank: `1`
