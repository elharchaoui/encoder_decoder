...
- Config: `configs/prefix_memory_qwen05_ce_squad_30k_seed37.yaml`
- Checkpoint: `runs/prefix_memory_qwen05_ce_squad_30k_seed37/best`
...
- Target: `a majority`
- Prefix-memory prediction: `the government`
...
- Prefix-memory prediction: `the first of the three great religions`
...
- Prefix-memory prediction: `the city of boston`
...
- Prefix-memory prediction: `the british empire`
