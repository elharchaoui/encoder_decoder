...
| `prediction_source_token_f1` | 0.0500 |
| `prediction_source_copy_ratio` | 0.3610 |
| `unique_predictions` | 345.0000 |
| `top_prediction_ratio` | 0.0723 |
| `empty_prediction_ratio` | 0.0020 |
| `avg_prediction_length_tokens` | 1.6094 |
| `max_prediction_length_tokens` | 5.0000 |
| `target_len_1_token_f1` | 0.3630 |
| `target_len_1_examples` | 180.0000 |
| `target_len_2_3_token_f1` | 0.2681 |
| `target_len_2_3_examples` | 332.0000 |
| `token_f1_gain_over_source_copy` | 0.2721 |
