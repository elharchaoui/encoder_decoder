...
- Config: `configs/t5_small_xa_squad_ctx192_eval.yaml`
...
| `prediction_source_token_f1` | 0.0443 |
| `prediction_source_copy_ratio` | 0.8116 |
| `unique_predictions` | 507.0000 |
| `top_prediction_ratio` | 0.0039 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 3.2148 |
| `max_prediction_length_tokens` | 14.0000 |
| `target_len_1_token_f1` | 0.6534 |
| `target_len_1_examples` | 154.0000 |
| `target_len_2_3_token_f1` | 0.7124 |
| `target_len_2_3_examples` | 221.0000 |
| `target_len_4_6_token_f1` | 0.6192 |
| `target_len_4_6_examples` | 91.0000 |
| `target_len_7_plus_token_f1` | 0.5779 |
| `target_len_7_plus_examples` | 46.0000 |
| `token_f1_gain_over_source_copy` | 0.6233 |
