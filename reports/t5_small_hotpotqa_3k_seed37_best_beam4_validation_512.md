...
- Config: `configs/t5_small_hotpotqa_3k_seed37_eval512.yaml`
- Checkpoint: `runs/t5_small_hotpotqa_3k_seed37/best`
...
| `prediction_source_token_f1` | 0.0150 |
| `prediction_source_copy_ratio` | 0.8101 |
| `unique_predictions` | 498.0000 |
| `top_prediction_ratio` | 0.0059 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 2.4004 |
| `max_prediction_length_tokens` | 12.0000 |
| `target_len_1_token_f1` | 0.1962 |
| `target_len_1_examples` | 132.0000 |
| `target_len_2_3_token_f1` | 0.2433 |
| `target_len_2_3_examples` | 288.0000 |
| `target_len_4_6_token_f1` | 0.3128 |
| `target_len_4_6_examples` | 79.0000 |
| `target_len_7_plus_token_f1` | 0.1846 |
| `target_len_7_plus_examples` | 13.0000 |
| `token_f1_gain_over_source_copy` | 0.2300 |
