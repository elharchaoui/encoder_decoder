...
- Config: `configs/t5_small_squad_3k_seed37_eval512.yaml`
- Checkpoint: `runs/t5_small_squad_3k_seed37/best`
- Data source: `qa`
...
| `prediction_source_token_f1` | 0.0419 |
| `prediction_source_copy_ratio` | 0.8147 |
| `unique_predictions` | 505.0000 |
| `top_prediction_ratio` | 0.0039 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 3.0391 |
| `max_prediction_length_tokens` | 14.0000 |
| `target_len_1_token_f1` | 0.7323 |
| `target_len_1_examples` | 154.0000 |
| `target_len_2_3_token_f1` | 0.7730 |
| `target_len_2_3_examples` | 221.0000 |
| `target_len_4_6_token_f1` | 0.6942 |
| `target_len_4_6_examples` | 91.0000 |
| `target_len_7_plus_token_f1` | 0.5940 |
| `target_len_7_plus_examples` | 46.0000 |
| `token_f1_gain_over_source_copy` | 0.6879 |
