...
- Config: `configs/t5_small_xa_squad_ctx128_eval.yaml`
...
| `prediction_source_token_f1` | 0.0463 |
| `prediction_source_copy_ratio` | 0.8075 |
| `unique_predictions` | 504.0000 |
| `top_prediction_ratio` | 0.0039 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 3.3438 |
| `max_prediction_length_tokens` | 15.0000 |
| `target_len_1_token_f1` | 0.5426 |
| `target_len_1_examples` | 154.0000 |
| `target_len_2_3_token_f1` | 0.5461 |
| `target_len_2_3_examples` | 221.0000 |
| `target_len_4_6_token_f1` | 0.5141 |
| `target_len_4_6_examples` | 91.0000 |
| `target_len_7_plus_token_f1` | 0.5105 |
| `target_len_7_plus_examples` | 46.0000 |
| `token_f1_gain_over_source_copy` | 0.4934 |
...
- Prediction: `all people, including adults`
- Exact match: `0.000`
- Token F1: `0.000`
- Prediction-source copy ratio: `1.000`
