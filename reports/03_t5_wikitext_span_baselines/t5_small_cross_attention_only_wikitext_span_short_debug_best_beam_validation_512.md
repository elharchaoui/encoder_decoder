...
| `prediction_source_token_f1` | 0.0588 |
| `prediction_source_copy_ratio` | 0.4351 |
| `unique_predictions` | 309.0000 |
| `top_prediction_ratio` | 0.0781 |
| `empty_prediction_ratio` | 0.0020 |
| `avg_prediction_length_tokens` | 1.6035 |
| `max_prediction_length_tokens` | 8.0000 |
| `target_len_1_token_f1` | 0.2093 |
| `target_len_1_examples` | 175.0000 |
| `target_len_2_3_token_f1` | 0.2310 |
| `target_len_2_3_examples` | 337.0000 |
| `token_f1_gain_over_source_copy` | 0.1942 |
