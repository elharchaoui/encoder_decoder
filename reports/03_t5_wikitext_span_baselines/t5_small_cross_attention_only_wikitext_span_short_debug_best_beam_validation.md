...
- Config: `configs/t5_small_cross_attention_only_wikitext_span_short_debug.yaml`
...
| `prediction_source_token_f1` | 0.0540 |
| `prediction_source_copy_ratio` | 0.4245 |
| `target_len_1_token_f1` | 0.3143 |
| `target_len_1_examples` | 20.0000 |
| `target_len_2_3_token_f1` | 0.2285 |
| `target_len_2_3_examples` | 44.0000 |
| `token_f1_gain_over_source_copy` | 0.2137 |
