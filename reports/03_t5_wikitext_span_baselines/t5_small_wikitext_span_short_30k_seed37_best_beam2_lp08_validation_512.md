...
- Config: `configs/t5_small_wikitext_span_short_30k_seed37_eval512.yaml`
- Checkpoint: `runs/t5_small_wikitext_span_short_30k_seed37/best`
...
| `prediction_source_token_f1` | 0.0452 |
| `prediction_source_copy_ratio` | 0.3349 |
| `unique_predictions` | 373.0000 |
| `top_prediction_ratio` | 0.0586 |
| `empty_prediction_ratio` | 0.0020 |
| `avg_prediction_length_tokens` | 1.6465 |
| `max_prediction_length_tokens` | 6.0000 |
| `target_len_1_token_f1` | 0.3781 |
| `target_len_1_examples` | 180.0000 |
| `target_len_2_3_token_f1` | 0.2780 |
| `target_len_2_3_examples` | 332.0000 |
| `token_f1_gain_over_source_copy` | 0.2839 |
