...
- Config: `configs/decoder_only_wikitext_span_target_debug.yaml`
- Checkpoint: `runs/decoder_only_wikitext_span_target_debug/best.pt`
...
| `prediction_source_token_f1` | 0.0619 |
| `prediction_source_copy_ratio` | 0.2865 |
| `encoder_calls_per_generation` | 1.0000 |
| `token_f1_gain_over_source_copy` | 0.0154 |
