...
| `prediction_source_token_f1` | 0.0520 |
| `prediction_source_copy_ratio` | 0.4453 |
| `encoder_calls_per_generation` | 1.0000 |
| `target_len_1_token_f1` | 0.0667 |
| `target_len_1_examples` | 20.0000 |
| `target_len_2_3_token_f1` | 0.0674 |
| `target_len_2_3_examples` | 44.0000 |
| `token_f1_gain_over_source_copy` | 0.0256 |
