...
| `token_f1_gain_over_source_copy` | -0.3102 |
| `decode_repetition_penalty` | 1.2500 |
...
- Prediction: `the was ', the the that wrote of the the the to the episode critics and ", the a the the, the. the the it the the`
- Exact match: `0.000`
- Token F1: `0.172`
...
- Prediction: `the, was the the the of the the a the the and the the @ the.`
- Exact match: `0.000`
- Token F1: `0.244`
...
- Prediction: `the, of the the the in the the as the the to the the critics and the the not the the of the that`
- Exact match: `0.000`
- Token F1: `0.167`
