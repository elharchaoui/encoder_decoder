...
- Config: `configs/t5_large_cross_attention_only_squad_30k_seed37_eval512.yaml`
...
| `prediction_source_token_f1` | 0.0449 |
| `prediction_source_copy_ratio` | 0.8098 |
| `unique_predictions` | 505.0000 |
| `top_prediction_ratio` | 0.0039 |
| `empty_prediction_ratio` | 0.0000 |
| `avg_prediction_length_tokens` | 3.3301 |
| `max_prediction_length_tokens` | 22.0000 |
| `target_len_1_token_f1` | 0.8078 |
| `target_len_1_examples` | 154.0000 |
| `target_len_2_3_token_f1` | 0.8144 |
| `target_len_2_3_examples` | 221.0000 |
| `target_len_4_6_token_f1` | 0.8338 |
| `target_len_4_6_examples` | 91.0000 |
| `target_len_7_plus_token_f1` | 0.7212 |
| `target_len_7_plus_examples` | 46.0000 |
| `token_f1_gain_over_source_copy` | 0.7648 |
| `bertscore_precision` | 0.7914 |
| `bertscore_recall` | 0.8005 |
| `bertscore_f1` | 0.7952 |
...
- Exact match: `0.000`
- Token F1: `0.105`
- Prediction-source copy ratio: `0.944`
