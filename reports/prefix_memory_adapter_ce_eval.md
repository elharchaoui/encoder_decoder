...
| `prefix_token_f1` | 0.0248 |
| `source_copy_token_f1` | 0.0382 |
| `prefix_prediction_source_copy_ratio` | 0.4246 |
| `decoder_baseline_exact_match` | 0.0078 |
| `decoder_baseline_token_f1` | 0.1273 |
| `decoder_baseline_prediction_source_copy_ratio` | 0.7202 |
| `prefix_unique_predictions` | 8.0000 |
| `prefix_top_prediction_ratio` | 0.7891 |
| `decoder_baseline_unique_predictions` | 128.0000 |
| `decoder_baseline_top_prediction_ratio` | 0.0078 |
| `prefix_gain_over_source_copy` | -0.0134 |
| `prefix_gap_to_decoder_baseline` | 0.1025 |
| `prefix_target_len_1_token_f1` | 0.0000 |
| `target_len_1_examples` | 37.0000 |
| `prefix_target_len_2_3_token_f1` | 0.0237 |
| `target_len_2_3_examples` | 62.0000 |
| `prefix_target_len_4_6_token_f1` | 0.0559 |
| `target_len_4_6_examples` | 22.0000 |
| `prefix_target_len_7_plus_token_f1` | 0.0683 |
